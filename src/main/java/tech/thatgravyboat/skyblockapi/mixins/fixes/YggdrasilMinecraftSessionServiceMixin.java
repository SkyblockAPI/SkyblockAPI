...
//~ if >= 26.3 'yggdrasil.YggdrasilMinecraftSessionService' -> 'services.MinecraftServicesSessionService'
@Mixin(value = com.mojang.authlib.services.MinecraftServicesSessionService.class, remap = false)
