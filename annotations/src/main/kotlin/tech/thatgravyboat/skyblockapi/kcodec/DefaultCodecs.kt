...
object DefaultCodecs {
    ...
    init {
        ...
        this.add("kotlin.time", "Duration", "tech.thatgravyboat.skyblockapi.utils.codecs.ModCodecs.DURATION")
        this.add("tech.thatgravyboat.skyblockapi.api.profile.community", "FameRank", "tech.thatgravyboat.skyblockapi.api.profile.community.FameRank.CODEC") { isString = true }
        this.add("tech.thatgravyboat.skyblockapi.api.profile.maxwell", "MaxwellPower", "tech.thatgravyboat.skyblockapi.api.profile.maxwell.MaxwellPower.CODEC") { isString = true }
